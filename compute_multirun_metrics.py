    ...
    #    os.makedirs(metric_subfolder)
        ...
        for metric in metrics:
            ...
            run_region_dict, idx_run_dict, run_percent_dict = collect_run_metrics(metric=metric,
                                                                ...
                                                                batch_multi_run=batch_multi_run,
                                                                runs_folder=runs_folder,
                                                                avg_multi=avg_multi,model=model,bins=bins)
...
def multi_model_metrics(models,  exp_dirs, write_dir, bins=None, runs='runs', data_name='',
    ...
    plt.savefig(os.path.join(write_folder, data_name+'_multi_model_performance' + '.png'))
    plt.close(fig)
...
def main():
    ...
    multi_run_metrics(exp_folder,model=model, bins= bins,metric=metric, runs=runs, plt_title=plt_title, avg_multi=False,
